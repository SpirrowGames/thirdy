...
from api.worker.jobs import audit_conversation_job, watch_conversation_job, classify_and_extract_spec_job, classify_and_extract_decision_job, auto_pipeline_job
...
class WorkerSettings:
    functions = [audit_conversation_job, watch_conversation_job, classify_and_extract_spec_job, classify_and_extract_decision_job, auto_pipeline_job]
